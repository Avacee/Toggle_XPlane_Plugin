...
PLUGIN_API int XPluginStart(char* outName, char* outSig, char* outDesc)
{
	...
	strcpy(outSig, "com.Marci353.ToggleSkyscapes");
	strcpy(outDesc, "Enable/Disable Skyscapes");
	...
	cmndref_ToggleSkyscapes = XPLMCreateCommand("Marci353/ToggleSckyscapes", "Enable or Disable Enhanced Skyscapes.");
